		 ...
		 <form action="tambahprosesdataemployee.php" method="post">
		  <table cellpadding="3" cellspacing="0">		   
		   ...
		   <tr>
				...
				<td>:</td>
			<td><p><input type="text" id="datepicker1"  name="ProbationEndDate"></p></td>    
			</td>
		   </tr>
		  <tr>
				...
				<td>:</td>
			<td>
			<p><input type="text" id="datepicker2"  name="StartContractDate"></p>
			</td>    
			</td>
		   </tr>
		   <tr>
				...
				<td>:</td>
			<td><p><input type="text" id="datepicker3"  name="EndContractDate"></p></td>    
			</td>
		   </tr>
		    <tr>
		   ...
		   <tr>
		    ...
		    <tr>
				...
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker4"  name="ResignDate"></p>
		   </tr>
			 <tr>
				<td>Resign Code </td>
				<td>:</td>
		   ...
		   <tr>
			...
			<td><input type="text" name="GradeCode" size="30" required></td>
	   	   ...
	   	   <tr>
				...
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker5"  name="GradeCodeChangeDate"></p>
		   </tr>
		   <tr>
				<td>Position Code</td>
				<td>:</td>
		   ...
		   <tr>
				...
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker6"  name="PositionCodeChangeDate"></p>
		   </tr>
		   <tr>
				<td>Rank Code</td>
				<td>:</td>
		    ...
		    <tr>
				...
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker7"  name="RankCodeChangeDate"></p>
		   </tr>
		   <tr>
				<td>Level 1 Code</td>
				<td>:</td>
		   ...
		   <tr>
				...
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker13"  name="Level1CodeChangeDate"></p>
		   </tr>
		   <tr>
				<td>Level 2 Code Change Date</td>
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker8"  name="Level2CodeChangeDate"></p>
		   </tr>
		   <tr>
				<td>Level 3 Code Change Date</td>
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker9"  name="Level3CodeChangeDate"></p>
		   </tr>
		   <tr>
				<td>Level 4 Code Change Date</td>
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker10"  name="Level4CodeChangeDate"></p>
		   </tr>
		   <tr>
				<td>Level 5 Code Change Date</td>
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker11"  name="Level5CodeChangeDate"></p>
		   </tr>
		   <tr>
		   ...
		   <tr>
				...
				<td>:</td>
			<td>
				<p><input type="text" id="datepicker12"  name="LastModifiedDate"></p>
		   </tr>
